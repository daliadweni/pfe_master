...
const ChevronIcon = () => (
  <svg
    ...
    className={
      ...
      + "group-hover:text-teal-500 dark:text-zinc-600"
    }
  >
    <path
      fillRule="evenodd"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={
        ...
        + "bg-gradient-to-l from-teal-600 to-teal-700 p-7 "
        + "text-white shadow-lg shadow-teal-700/20 "
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-teal-100">
              فضاء للاستكشاف: جرّب المفاهيم في المختبر الافتراضي،
              ثم ثبّت تعلّمك.
            </p>
          </div>
        </div>
        ...
        <div className="relative mt-5">
          <div className={
            "flex items-center justify-between text-xs text-teal-200"
          }>
            <span>
          ...
          <div className={
            "mt-1.5 h-2.5 overflow-hidden rounded-full bg-teal-900/40"
          }>
            <div
              className={
                ...
                className={
                  ...
                  + (isComplete
                    ...
                    : "border-zinc-200 hover:border-teal-300 "
                      + "dark:border-zinc-800 dark:hover:border-teal-700")
                }
              >
                <div
                  className={
                    ...
                    + (isComplete
                      ...
                      : "bg-teal-50 text-teal-700 "
                        ...
                        + "dark:bg-teal-950/40 dark:text-teal-300")
                  }
                >
                    ...
                    {labels.map((label, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          />
                          <span className={
                            "hidden text-[9px] text-zinc-400 sm:block"
                          }>
                            {label}
                          </span>
                        </div>
